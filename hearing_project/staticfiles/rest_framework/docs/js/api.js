...
$(function () {
  ...
  // Authentication: none
  $authControl.find("[data-login='none']").click(function (event) {
    event.preventDefault()
    window.auth = null
    $selectedAuthentication.text('none')
    $authControl.find("[data-login]").closest('li').removeClass('active')
    $authControl.find("[data-login='none']").closest('li').addClass('active')
  })
  ...
  $('form.authentication-token-form').submit(function (event) {
    ...
    $authControl.find("[data-login]").closest('li').removeClass('active')
    $authControl.find("[data-login='token']").closest('li').addClass('active')
  ...
  $('form.authentication-basic-form').submit(function (event) {
    ...
    $authControl.find("[data-login]").closest('li').removeClass('active')
    $authControl.find("[data-login='basic']").closest('li').addClass('active')
  ...
  $('form.authentication-session-form').submit(function (event) {
    ...
    $authControl.find("[data-login]").closest('li').removeClass('active')
    $authControl.find("[data-login='session']").closest('li').addClass('active')
