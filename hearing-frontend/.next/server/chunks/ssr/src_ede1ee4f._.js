...
function AuthPage() {
    ...
    const auth = async (e)=>{
        ...
        try {
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$request$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NetworkService"].requestCode({
                email: email
            });
            console.log(res);
            if (res.status === 400) {
...
//# sourceMappingURL=src_ede1ee4f._.js.map