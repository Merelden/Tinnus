...
function AuthPage() {
    ...
    const auth = async (e)=>{
        ...
        try {
            ...
            if (res.status === 200) {
                const streakRes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$request$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NetworkService"].streak();
                const testDay = streakRes?.data?.is_test_day;
                if (testDay) {
                    router.push("/test");
                } else {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b63d8dce._.js.map