...
"[project]/node_modules/@react-pdf-viewer/core/lib/cjs/core.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var useIsomorphicLayoutEffect = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : React__namespace.useEffect;
...
var vendor = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : defaultVendor;
...
var exitFullScreen = function(element) {
    return ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : Promise.resolve({});
};
...
var isDarkMode = function() {
    return "undefined" !== 'undefined' && window.matchMedia && window.matchMedia('(prefers-color-scheme: dark)').matches;
};
var withTheme = function(theme, onSwitchTheme) {
    var initialTheme = React__namespace.useMemo(function() {
        return theme === 'auto' ? isDarkMode() ? "TURBOPACK unreachable" : 'light' : theme;
    }, []);
...
"[project]/node_modules/@react-pdf-viewer/core/lib/index.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
