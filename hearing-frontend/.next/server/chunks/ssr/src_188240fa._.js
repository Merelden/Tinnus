...
"[project]/src/app/(auth)/oAuth/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function OAuthPage() {
    ...
    const register = async (e)=>{
        ...
        try {
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$request$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NetworkService"].completeProfile({
                email: email,
                full_name: name,
                age: age,
                phone: phone
...
//# sourceMappingURL=src_188240fa._.js.map