    ...
    static async request(method, url, data, config) {
        ...
        try {
            ...
            if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].isAxiosError(err)) {
                ...
                // }
                // Normalize server errors to a simple string message
                ...
                if (typeof data === 'string') {
                    ...
                    try {
                        ...
                        values.forEach((v)=>{
                            if (Array.isArray(v)) {
                                v.forEach((i)=>parts.push(String(i)));
                            } else {
                                parts.push(String(v));
                            }
                        });
...
function RegisterPage() {
    ...
    const register = async (e)=>{
        e.preventDefault();
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$request$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NetworkService"].register({
                user: {
                    email: email,
                    password: password
                },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f2dc192c._.js.map