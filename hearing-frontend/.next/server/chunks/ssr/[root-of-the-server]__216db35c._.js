...
`;
const InputAuth = ({ image, label, value, onChange, type })=>{
    ...
    static async request(method, url, data, config) {
        ...
        try {
            ...
            if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].isAxiosError(err)) {
                ...
                const serverMessage = err.response?.data?.message || "Server Error";
...
"[externals]/next/dist/shared/lib/runtime-config.external.js [external] (next/dist/shared/lib/runtime-config.external.js, cjs)": ((__turbopack_context__) => {
...
function AuthPage() {
    ...
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null); // Состояние для ошибки
    const auth = async (e)=>{
        e.preventDefault();
        try {
            setError(null);
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$request$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NetworkService"].login({
                email: email,
                password: password
            });
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$client$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["router"].push("/start");
        } catch (error) {
            console.log(error);
        }
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__216db35c._.js.map