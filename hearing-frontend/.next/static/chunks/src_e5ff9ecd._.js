...
const QuestionsForm = ()=>{
    ...
    const handleSubmit = async ()=>{
        ...
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$request$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NetworkService"].answers(payload);
        console.log(res);
    };
