                ...
                "OAuthBtns.useEffect": async (payload)=>{
                    ...
                    try {
                        if (VKID.Auth && typeof VKID.Auth.exchangeCode === 'function') {
                            ...
                            // Нормализуем данные из userinfo
                            const firstName = (dataBaba === null || dataBaba === void 0 ? void 0 : dataBaba.given_name) || (dataBaba === null || dataBaba === void 0 ? void 0 : dataBaba.first_name) || '';
                            const lastName = (dataBaba === null || dataBaba === void 0 ? void 0 : dataBaba.family_name) || (dataBaba === null || dataBaba === void 0 ? void 0 : dataBaba.last_name) || '';
                            const picture = (dataBaba === null || dataBaba === void 0 ? void 0 : dataBaba.picture) || '';
                            const email = ((dataBaba === null || dataBaba === void 0 ? void 0 : dataBaba.email) || (tokenRes === null || tokenRes === void 0 ? void 0 : tokenRes.email) || '').toString();
                            try {
                                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$request$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NetworkService"].csrf();
                            } catch (e) {}
                    ...
                    try {
                        ...
                        var _err_response;
                        console.error('Server-side VK auth error:', ((_err_response = err.response) === null || _err_response === void 0 ? void 0 : _err_response.data) || err);
                    }
                }
            }["OAuthBtns.useEffect"]);
        }
